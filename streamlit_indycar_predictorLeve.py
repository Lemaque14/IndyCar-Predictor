...
def load_model_and_schema(model_path: str, data_path: str):
    ...
    X_col = df.drop(columns=['PositionFinish']).columns.tolist()
    return model, X_col

model, FEATURE_COLS = load_model_and_schema(
    model_path="C:\\Users\\ripa_\\Downloads\\indycar_xgb_v5.json",
    data_path='C:\\Users\\ripa_\\Downloads\\IndyCar Regression Data_v5.csv'
)
